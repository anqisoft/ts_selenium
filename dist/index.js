...
export { Builder, By, WebElement, Key, until, WebDriver } from 'npm:selenium-webdriver';
 ...
 */
export async function getHeadlessDriver(name) {
    switch (name) {
 ...
 */
export async function sendKeysAndReturn(element, content) {
 ...
 */
export async function findElementByCss(driver, css) {
 ...
 */
export async function waitUtilElementLocatedByCss(driver, css, milliseconds) {
 ...
 */
export async function waitUtilElementLocatedByCssAndGetText(driver, css, milliseconds) {
    await driver.wait(until.elementLocated(By.css(css)), milliseconds);
...
let SeleniumHelper = /** @class */ (() => {
    class SeleniumHelper {
         ...
         * @returns <en_us>Browser driver</en_us><zh_cn>浏览器驱动程序</zh_cn><zh_tw>瀏覽器驅動程序</zh_tw>
         */
        static async getSingletonHeadlessDriver(name) {
         ...
         */
        static async getSingletonHeadlessChromeDriver() {
         ...
         */
        static async getSingletonHeadlessIeDriver() {
         ...
         */
        static async getSingletonHeadlessEdgeDriver() {
         ...
         */
        static async getSingletonHeadlessFirefoxDriver() {
         ...
         */
        static async getSingletonHeadlessOperaDriver() {
         ...
         */
        static async getSingletonHeadlessSafariDriver() {
         ...
         * @param name {BrowserName} <en_us>browser name</en_us><zh_cn>浏览器名称</zh_cn><zh_tw>瀏覽器名稱</zh_tw>
         */
        static async closeSingletonHeadlessDriver(name) {
     ...
     */
    SeleniumHelper._headlessDriverMap = {
        chrome: null,
        ie: null,
        edge: null,
        firefox: null,
